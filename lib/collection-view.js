  ...
  Backbone.CollectionView = Backbone.View.extend({
    ...
    initialize: function (options) {
      ...
      if (this.collection) {
        ...
        this.collection.each(function (model, i) {
          this.addSubviewForItemAtIndex(model, i);
        }, this);
      }
    },
    ...
    renderAllItems: function () {
      ...
      _.each(items, function (item, i) {
        that.addSubviewForItemAtIndex(item, i);
      });
    ...
    addSubviewForItemAtIndex: function (model, index) {
    ...
    addSubviewForItem: function (model) {
      this.addSubviewForItemAtIndex(model, this._subviews.length);

      return this;
    },

    removeSubviewForItem: function (model) {
      var view = this.getSubviewForItem(model);
    ...
    _onAdd: function (item, collection, options) {
      this.addSubviewForItemAtIndex(item, options.at);
    },

    _onRemove: function (item, collection, options) {
      this.removeSubviewForItem(item);
    }
  });
